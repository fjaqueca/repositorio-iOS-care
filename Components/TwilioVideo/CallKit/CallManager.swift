...
//        handleError(VideoError.callKitReset)
//    }
//
...
//        
//        let roomName = action.handle.value
//
////        Task {
////            let result = await Network.shared.getVideoCall(roomName: roomName)
////            switch result {
////                case let .success(videoCall):
////                    let connectOptions = ConnectOptions(token: videoCall.token) { (builder) in
////                        builder.roomName = videoCall.roomName
////
...
////                        if let camera = CameraSource(delegate: self.twilioDelegate) {
...
////                        }
////                    }
////                    let room = TwilioVideoSDK.connect(options: connectOptions, delegate: self.twilioDelegate)
////                    self.twilioDelegate.room = room
